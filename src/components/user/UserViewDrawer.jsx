                ...
                >
                  ...
                  <div className="bg-zinc-900 border-t border-zinc-700 p-3 flex gap-2 justify-end">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 bg-blue-600 hover:bg-blue-700 text-white px-4 py-1.5 rounded-md text-xs font-semibold transition shadow-md disabled:opacity-75"
                    >
                      {isDownloading ? (
                        <>
